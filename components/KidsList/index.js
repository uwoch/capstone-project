...
import { StyledList, StyledListContainer,
    StyledListItem, StyledImage, StyledParagraph, StyledLink, StyledSection, StyledHeadline, StyledAddChildLink, StyledContainer } from "./KidsList.styled";
...
export default function KidsList() {
  ...
  if (!data || data.length === 0) {
    return (
      <StyledContainer>
        <StyledHeadline>Du hast noch kein Kind angelegt, für das du loggen kannst. Füge hier ein Kind hinzu:</StyledHeadline>
