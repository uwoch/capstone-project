import { StyledFooter, StyledHomeLink, StyledAddChildLink } from "./Footer.styled";

export default function Footer() {
    return (
        <StyledFooter>
            <StyledHomeLink href="/">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#016e82" viewBox="0 0 16 16">
